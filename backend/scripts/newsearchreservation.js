  ...
  loadAllowLogin: function (callback) {
    $.ajax({
      ...
      success: function (datalog) {
        ...
        this.setState({ viewthepage: this.state.data[0].dbusertype }, callback);
  ...
  loadReservationsFromServer: function (formState) {
    this.loadAllowLogin(() => {
      if (this.state.viewthepage > 0) {
        console.log('Current Admin Level Invalid');
        return;
      }
      ...
      $.ajax({
        ...
        data: {
          ...
          'reservationplayer': jwresplayer.value,
...
var Reservationform2 = React.createClass({
  ...
  handleSubmit: function (e) {
    ...
    var reservationplayer = jwresplayer.value;
    ...
    var reservationNodes = this.props.data.map(function (reservation) {
      return (
        <Reservation
          ...
          resplayer={reservation.dbplayername}
