    ...
    handleCartSubmit: function (Cart) {
        ...
        $.ajax({
            ...
            error: function (xhr, status, err) {
                ...
                alert("Cart Has Been Submitted to the Player.");
            }.bind(this)
        });
    },
...
var Cartform = React.createClass({
    ...
    handleSubmit: function (e) {
        ...
        var CartPlayer = jwplayernum.value;

        console.log("User Num: " + CartUser);
        console.log("User Player: " + CartPlayer);
...
var SelectPlayer = React.createClass({
    render: function () {
        var optionNodes = this.props.data.map(function (playerID) {
            return (
                <option
                    key={playerID.dbplayerkey}
                    value={playerID.dbplayerkey}
                >
                    {playerID.dbplayername}
                </option>
            );
        });
        return (
            <select name="jwplayernum" id="jwplayernum">
                {optionNodes}
            </select>
        );
    }
