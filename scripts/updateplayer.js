...
var PlayerUpdateform = React.createClass({
    ...
    handleUpSubmit: function (e) {
        ...
        var upjwplayertype = upjwptype.value;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var populatePlayer = this.state.singledata.map(function (player) {
                    ...
                    upjwptype.value = player.dbplayertype;
...
var SelectUpdateList = React.createClass({
    render: function () {
        ...
        return (
            <select name="upjwptype" id="upjwptype">
                <option value="0"></option>
                {optionNodes}
            </select>
        );
